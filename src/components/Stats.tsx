      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 auto-rows-auto">
          ...
          <motion.div
            ...
            className="lg:col-span-7 lg:row-span-2 relative bg-[#111111]/60 backdrop-blur-md rounded-2xl p-8 sm:p-10 md:p-14 border border-white/5 flex flex-col justify-center gap-4 sm:gap-6 overflow-hidden group"
          >
            {/* Glow */}
            ...
            <div className="flex items-center gap-4 sm:gap-6 relative z-10">
              <span className="text-[3.5rem] sm:text-[5rem] md:text-[7rem] lg:text-[8rem] font-black text-brand leading-none tracking-tighter">+5</span>
          ...
          {rightStats.map((stat, i) => (
            <motion.div
              ...
              className={`relative bg-[#111111]/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 md:p-10 flex flex-col items-center justify-center text-center border border-white/5 overflow-hidden group transition-all duration-500 hover:border-brand/20 hover:shadow-[0_0_40px_rgba(212,175,55,0.06)] ${
            ...
            >
              ...
              <h4 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-2 sm:mb-3 group-hover:text-brand transition-colors duration-300 relative z-10 tracking-tight">
                {stat.value}
              </h4>
